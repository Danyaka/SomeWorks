        ...
        try {
            switch (args[2].toUpperCase()) {
                ...
                case GET:
                    ...
                    if (provider.getClient(Long.parseLong(args[3])) == null)
                        return ("record not found");
                    else return provider.getClient(Long.parseLong(args[3])).toString();
                case DEL:
                    assert args.length != 4;
    ...
    private static String postOffice(IDataProvider provider, String[] args) {
        try {
            switch (args[2].toUpperCase()) {
                ...
                case GET:
                    assert args.length != 4;
                    if (provider.getPostOffice(Long.parseLong(args[3])) == null)
                        return ("record not found");
                    else return provider.getPostOffice(Long.parseLong(args[3])).toString();
                case DEL:
                    assert args.length != 4;
    ...
    private static String mark(IDataProvider provider, String[] args) {
        try {
            switch (args[2].toUpperCase()) {
                ...
                case GET:
                    assert args.length != 4;
                    if (provider.getMark(Long.parseLong(args[3])) == null)
                        return ("record not found");
                    else return provider.getMark(Long.parseLong(args[3])).toString();
                case DEL:
                    assert args.length != 4;
    ...
    private static String envelope(IDataProvider provider, String[] args) {
        try {
            switch (args[2].toUpperCase()) {
                ...
                case GET:
                    assert args.length != 4;
                    if (provider.getEnvelope(Long.parseLong(args[3])) == null)
                        return ("record not found");
                    else return provider.getEnvelope(Long.parseLong(args[3])).toString();
                case DEL:
                    assert args.length != 4;
    ...
    private static String money(IDataProvider provider, String[] args) {
        try {
            switch (args[2].toUpperCase()) {
                ...
                case GET:
                    assert args.length != 4;
                    if (provider.getMoney(Long.parseLong(args[3])) == null)
                        return ("record not found");
                    else return provider.getMoney(Long.parseLong(args[3])).toString();
                case DEL:
                    assert args.length != 4;
    ...
    private static String letter(IDataProvider provider, String[] args) {
        try {
            switch (args[2].toUpperCase()) {
                ...
                case GET:
                    assert args.length != 4;
                    if (provider.getLetter(Long.parseLong(args[3])) == null)
                        return ("record not found");
                    else return provider.getLetter(Long.parseLong(args[3])).toString();
                case DEL:
                    assert args.length != 4;
                    return provider.delMoney(Long.parseLong(args[3])).getAnswer();
                case GIVE:
    ...
    private static String packages(IDataProvider provider, String[] args) {
        try {
            switch (args[2].toUpperCase()) {
                ...
                case GET:
                    assert args.length != 4;
                    if (provider.getPackage(Long.parseLong(args[3])) == null)
                        return ("record not found");
                    else return provider.getPackage(Long.parseLong(args[3])).toString();
                case DEL:
                    assert args.length != 4;
    ...
    private static String valuablePack(IDataProvider provider, String[] args) {
        try {
            switch (args[2].toUpperCase()) {
                ...
                case GET:
                    assert args.length != 4;
                    if (provider.getValuablePack(Long.parseLong(args[3])) == null)
                        return ("record not found");
                    else return provider.getValuablePack(Long.parseLong(args[3])).toString();
                case DEL:
                    assert args.length != 4;
